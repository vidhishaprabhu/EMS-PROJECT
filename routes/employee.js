...
const {createEmployee,login,getEmployee,getEmployeeInfo,getEmployeeById,forgetPasswordEmployee,changePasswordEmployee,updateEmployee,deleteEmployee}=require('../controllers/employee')
...
router.put('/forget-password-employee',forgetPasswordEmployee)
